...
<div class="row-fluid sortable">
  <div class="box span12">
    ...
    <div class="box-content">
      <div class="box-content">
	    <?=$msg?>
        <form class="form-horizontal" method="post" action="index.php" id="frmIQTest" name="frmIQTest">
        ...
        <input type="hidden" name="pk_id" id="pk_id" value="<?=$_REQUEST['id']?>" />
          <fieldset>
            <div class="control-group">
              ...
              <div class="controls"> 
               <input type="text" required value="" id="data_examinee_firstn" name="data_examinee_firstn" class="input-xsmall focused" ></div>
            </div>
             
            <div class="control-group">
              <label class="control-label" for="data_fname"><?=$lang['Last Name']?></label>
              <div class="controls">
                <input type="text" required value="" id="data_examinee_lastn" name="data_examinee_lastn" class="input-xsmall focused">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
	            <?=$objHTML->radioBox('examinee_gender', 'examinee_gender_M', 'M', 'Male', 'M')?>
	            <?=$objHTML->radioBox('examinee_gender', 'examinee_gender_F', 'F', 'Female', '')?>                
              </div>
            </div>
             ...
             <div class="control-group">
              ...
              <div class="controls">
	            <?=$objHTML->radioBox('examinee_handedness', 'examinee_handedness_R', 'R', 'Right', 'R')?>
	            <?=$objHTML->radioBox('examinee_handedness', 'examinee_handedness_L', 'L', 'Left', '')?>
              </div>
            </div>
            <div class="control-group">
