...
<div>
    <ul class="breadcrumb">
        ...
        <li><a href="#"><?=$lang['Edit Redeem']?></a></li>
   </ul>
</div>
        ...
        <input type="hidden" name="pk_id" id="pk_id" value="<?=$_REQUEST['id']?>" />
          <fieldset>
            <div class="control-group">
              ...
              <div class="controls"> 
               <input type="text" required value="<?=$row->first_name?>" id="data_first_name" name="data_first_name" class="input-xsmall focused" ></div>
            </div>
             
            <div class="control-group">
              <label class="control-label" for="data_fname"><?=$lang['Last Name']?></label>
              <div class="controls">
                <input type="text" required value="<?=$row->last_name?>" id="data_last_name" name="data_last_name" class="input-xsmall focused">
              </div>
            </div>

            <div class="control-group">
              <label class="control-label" for="name"><?=$lang['Birth Date Time']?></label>
              <div class="controls"><?=$objHTML->basicDateCombo($arrTimeName, $arrDateName, $BirthDate,'required').' Time: '.$objHTML->basicTimeCombo($arrTimeName, $arrTimeName, $BirthTime, 'required');?></div>
            </div>
          
            <div class="control-group">
              <label class="control-label" for="name"><?=$lang['Gender']?></label>
              <div class="controls">
	            <?=$objHTML->radioBox('gender', 'gender_M', 'M', 'Male', $row->gender)?>
	            <?=$objHTML->radioBox('gender', 'gender_F', 'F', 'Female', $row->gender)?>                
              </div>
            </div>
