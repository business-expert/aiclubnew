           ...
           <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="input-prepend">
				 <span class="add-on"><i class="icon-envelope"></i></span><input type="email" required  value="<?=$row->email_address?>" id="data_email_address" onchange="checkDuplicateEmail();" name="data_email_address" class="input-xsmall focused" data-validation-email-message="Please enter valid Email Address"></div>&nbsp;&nbsp;&nbsp;<span class="label label-info"><?=$lang['email_verification_note']?></span></div><div id="ajax_email" style="color:red;margin: 0px 0px 0px 164px;"></div>
            </div>
            ...
            <div class="control-group">
              <label class="control-label" for="data_state"><?=$lang['Region']?></label>
              <div class="controls"><?=$objHTML->getRegionSelectBox("data_region", $row->region, $extra='')?></div>
            </div>
            <div class="control-group">
              <label class="control-label" for="data_city"><?=$lang['District']?></label>
				<div class="controls"><?=$objHTML->getDistrictSelectBox("data_district", $row->district, $extra='')?></div>
            </div>
             <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="input-prepend input-append" style="margin-left:21px;">
                <span class="add-on"><?=CURRENCY?></span><input type="number" value="" id="txt_income_from" name="txt_income_from" class="input-xsmall focused" style="width:80px;">
                &nbsp;to&nbsp;
                <span class="add-on"><?=CURRENCY?></span><input type="number" value="" id="txt_income_to" name="txt_income_to" class="input-xsmall focused" style="width:80px;">
